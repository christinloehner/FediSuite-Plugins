...
1. remove or comment out the `./plugins:/app/plugins` lines from `docker-compose.yml`
...
```yaml
- /home/yourname/FediSuite-Plugins:/app/plugins
```
...
For most self-hosters, `./plugins:/app/plugins` is the best option.
